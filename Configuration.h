...
#define STRING_CONFIG_H_AUTHOR "Marfrost" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pawuk v1.4"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  34.5
    #define DEFAULT_Ki   5.77
    #define DEFAULT_Kd 51.5
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 89.59
  #define DEFAULT_bedKi 12.87
  #define DEFAULT_bedKd 415.87
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -30, -1.4 }
