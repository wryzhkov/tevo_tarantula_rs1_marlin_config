...
#define CUSTOM_MENU_CONFIG
  ...
  #define CONFIG_MENU_ITEM_1_DESC "Disable software endstops"
  #define CONFIG_MENU_ITEM_1_GCODE "M211 S0"
  //#define CONFIG_MENU_ITEM_1_CONFIRM        // Show a confirmation dialog before this action

  #define CONFIG_MENU_ITEM_2_DESC "Enable software endstops"
  #define CONFIG_MENU_ITEM_2_GCODE "M211 S1"
  //#define CONFIG_MENU_ITEM_2_CONFIRM

  #define CONFIG_MENU_ITEM_3_DESC "Set 0 position"
  #define CONFIG_MENU_ITEM_3_GCODE "G92 X0 Y0 Z0 "
  #define CONFIG_MENU_ITEM_3_CONFIRM

  #define CONFIG_MENU_ITEM_4_DESC "Set 0 position Z"
  #define CONFIG_MENU_ITEM_4_GCODE "G92 Z0"
